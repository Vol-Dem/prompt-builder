  ...
  return (
    <>
      ...
      <TextContentBlock>
        ...
        <AboutTagSets />
        <H3 id="images">Generated Images</H3>
        <Text>
        ...
        <Text>
          ...
          of an image. If there is more than one image, a popup window will open
          where you can select the images you want to save. Click{" "}
