...
export const SETTINGS_IMAGE_INTERSECTION_MARGIN = 1000;
export const SETTINGS_AUTOPLAY_VIDEO = true;
export const SETTINGS_AUTOPLAY_VIDEO_INTERSECTION_MARGIN = 200;
...
export const SETTINGS_CAROUSEL_AUTOPLAY_VIDEO_PREVIEW = true;
